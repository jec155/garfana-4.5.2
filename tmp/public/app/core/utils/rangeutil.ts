...
var rangeOptions = [
  { from: 'now/d',    to: 'now/d',    display: '今天当天',                 section: 2 },
  { from: 'now/d',    to: 'now',      display: '今天截止',          section: 2 },
  { from: 'now/w',    to: 'now/w',    display: '本周',             section: 2 },
  { from: 'now/w',    to: 'now',      display: '本周截止',      section: 2 },
  { from: 'now/M',    to: 'now/M',    display: '本月',            section: 2 },
  { from: 'now/M',    to: 'now',      display: '本月截止',     section: 2 },
  { from: 'now/y',    to: 'now/y',    display: '本年',             section: 2 },
  { from: 'now/y',    to: 'now',      display: '本年截止',      section: 2 },

  { from: 'now-1d/d', to: 'now-1d/d', display: '昨天',             section: 1 },
  { from: 'now-2d/d', to: 'now-2d/d', display: '前天',  section: 1 },
  { from: 'now-7d/d', to: 'now-7d/d', display: '本周最后一天',    section: 1 },
  ...
  { from: 'now-90d',  to: 'now',      display: '过去90天',          section: 0 },
  { from: 'now-6M',   to: 'now',      display: '过去6月',         section: 0 },
  { from: 'now-1y',   to: 'now',      display: '过去1年',           section: 0 },
  { from: 'now-2y',   to: 'now',      display: '过去2年',          section: 0 },
  { from: 'now-5y',   to: 'now',      display: '过去5年',          section: 0 },
];
